...
@section('content')
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="/ulasan-update" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                @csrf
                <input type="text" id="ulasan_id" name="ulasan_id" value="{{ $model['id']}}" hidden>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"> Name <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" name="name" class="form-control" value="{{ $model['name']}}" required placeholder="Company Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="work" class="form-control" value="{{ $model['work'] }}" required placeholder="Company Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="description" class="form-control" value="{{ $model['work'] }}" required placeholder="Company Name">
                    </div>
                </div>
                ...
                <div class="form-group row" id="row_img_company">
                    ...
                    <div class="col-lg-9">
                        <img id="icon_old" class="company_image" src="{{ $model['img_url'] }}">
                        <img id="icon_new" class="company_image" src="">
