...
@section('content')
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="/supplier-update" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                @csrf
                <input type="text" id="supplier_id" name="supplier_id" value="{{ $model['id']}}" hidden>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="address" class="form-control" value="{{ $model['address'] }}" required placeholder="Address">
                    </div>
                </div>
