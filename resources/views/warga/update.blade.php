...
@section('content')
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="/warga-update" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                @csrf
                <input type="text" id="warga_id" name="warga_id" value="{{ $model['id']}}" hidden>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"> No KK <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" name="no_kk" class="form-control" value="{{ $model['no_kk']}}" required placeholder="no_kk">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="name" class="form-control" value="{{ $model['name'] }}" required placeholder="name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="nik" class="form-control" value="{{ $model['nik'] }}" required placeholder="nik">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control" name="gender" required>
                            ...
                            <option value="laki-laki" {{ $model['gender'] == 'laki-laki' ? 'selected' : '' }}>laki-laki</option>
                            <option value="perempuan" {{ $model['gender'] == 'perempuan' ? 'selected' : '' }}>perempuan</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="date" name="birth_date" class="form-control" value="{{ $model['birth_date'] }}" required placeholder="tanggal lahir">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control" name="golongan_darah" required>
                            ...
                            <option value="A" {{ $model['golongan_darah'] == 'A' ? 'selected' : '' }}>A</option>
                            <option value="B" {{ $model['golongan_darah'] == 'B' ? 'selected' : '' }}>B</option>
                            <option value="AB" {{ $model['golongan_darah'] == 'AB' ? 'selected' : '' }}>AB</option>
                            <option value="O" {{ $model['golongan_darah'] == 'O' ? 'selected' : '' }}>O</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control" name="religion" required>
                            ...
                            <option value="Katolik" {{ $model['religion'] == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                            <option value="Hindu" {{ $model['religion'] == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                            <option value="Budda" {{ $model['religion'] == 'Budda' ? 'selected' : '' }}>Budda</option>
                            <option value="Konghucu" {{ $model['religion'] == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="pendidikan" class="form-control" value="{{ $model['pendidikan'] }}" required placeholder="pendidikan">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="pekerjaan" class="form-control" value="{{ $model['pekerjaan'] }}" required placeholder="pekerjaan">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="alamat" class="form-control" value="{{ $model['alamat'] }}" required placeholder="alamat">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control" name="status_perkawinan" required>
                            ...
                            <option value="Belum Menikah" {{ $model['status_perkawinan'] == 'Belum Menikah' ? 'selected' : '' }}>belum menikah</option>
                            <option value="Menikah" {{ $model['status_perkawinan'] == 'Menikah' ? 'selected' : '' }}>menikah</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="tempat_dikeluarkan" class="form-control" value="{{ $model['tempat_dikeluarkan'] }}" required placeholder="tempat dikeluarkan">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="date" name="tanggal_dikeluarkan" class="form-control" value="{{ $model['tanggal_dikeluarkan'] }}" required placeholder="tanggal dikeluarkan">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="status_keluarga" class="form-control" value="{{ $model['status_keluarga'] }}" required placeholder="status keluarga">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="kewarganegaraan" class="form-control" value="{{ $model['kewarganegaraan'] }}" required placeholder="kewarganegaraan">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="nama_ayah" class="form-control" value="{{ $model['nama_ayah'] }}" required placeholder="nama ayah">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="nama_ibu" class="form-control" value="{{ $model['nama_ibu'] }}" required placeholder="nama ibu">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="date" name="tanggal_mulai" class="form-control" value="{{ $model['tanggal_mulai'] }}" required placeholder="tanggal mulai">
                    </div>
                </div>
