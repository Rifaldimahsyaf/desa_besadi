...
@section('content')
    <div class="card">
        ...
        <hr>
        <div class="card-body">
            <form action="/karyawan-update" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                @csrf
                <input type="text" id="karyawan_id" name="karyawan_id" value="{{ $model['id']}}" hidden>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"> NIP <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" name="nip" class="form-control" value="{{ $model['nip']}}" required placeholder="Name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="nama_lengkap" class="form-control" value="{{ $model['nama_lengkap'] }}" required placeholder="Address">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="email" class="form-control" value="{{ $model['email'] }}" required placeholder="Address">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="alamat" class="form-control" value="{{ $model['alamat'] }}" required placeholder="Address">
                    </div>
                </div>
