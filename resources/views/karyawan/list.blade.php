    ...
    <script type="text/javascript">
                                ...
                                return '<div class="list-icons">'+
                                            '<div class="dropdown">'+
                                                ...
                                                '<div class="dropdown-menu dropdown-menu-right">'+
                                                    '<a href="/karyawan/update/'+row['id']+'" class="dropdown-item">'+
                                                        '<i class="icon-pencil3"></i>Edit'+
                                                    '</a>'+
                                                    '<a href="#" class="dropdown-item btn-resend-creds" karyawan_id="' + row['id'] + '">'+
        ...
        $(function(){
            ...
            $('body').delegate('.btn-resend-creds', 'click', function(e){
                $karyawan_id = $(this).attr('karyawan_id')
                $('#modal-resend-creds #karyawan_id').val($karyawan_id);
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <button type="submit" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-add-ulasan"><i class="fas fa-plus mr-2"></i>Add Karyawan</button>
        </div>
        ...
        <div class='modal-dialog modal-small'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <form action="karyawan" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                        @csrf
        
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3"> NIP <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" name="nip" class="form-control" value="" required placeholder="Name">
                            </div>
                        </div>
        
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3"> Nama Lengkap <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" name="nama_lengkap" class="form-control" value="" required placeholder="Work">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="email" class="form-control" value="" required placeholder="Work">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="alamat" class="form-control" value="" required placeholder="Work">
                            </div>
                        </div>
    ...
    <div id='modal-resend-creds' class='modal fade' tabindex='-1'>
        <div class='modal-dialog modal-xs'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <h3 class="d-flex justify-content-center" style="margin: auto">Delete this Karyawan ?</h3>
                    <br>
                    <div class="text-right">
