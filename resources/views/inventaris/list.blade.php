    ...
    <script type="text/javascript">
        ...
        var DatatableCustomButtonWithSearch = function() {
            ...
            var _componentDatatableAPI = function() {
                ...
                var table = $('.datatable-button-init-custom').DataTable({
                    ...
                    processing: true,
                    // serverSide: true,
                    ajax: "/inventaris/list",
                    columns: [
                        {data:'jenis_barang'},
                        {data:'asal_barang'},
                        {data:'keadaan_barang'},
                        {data:'penghapusan_barang'},
                        {data:'keterangan'},
                        {
                            data:'Actions',
                                ...
                                return '<div class="list-icons">'+
                                            '<div class="dropdown">'+
                                                ...
                                                '<div class="dropdown-menu dropdown-menu-right">'+
                                                    ...
                                                    '<a href="/inventaris/update/'+row['id']+'" class="dropdown-item">'+
                                                        '<i class="icon-pencil3"></i>Edit'+
                                                    '</a>'+
                                                    '<a href="#" class="dropdown-item btn-resend-creds" inventaris_id="' + row['id'] + '">'+
        ...
        $(function(){
            ...
            $('body').delegate('.btn-resend-creds', 'click', function(e){
                $inventaris_id = $(this).attr('inventaris_id')
                $('#modal-resend-creds #inventaris_id').val($inventaris_id);
...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">List Inventaris</h5>
        </div>

      <div class="card-body d-flex justify-content-end gap-2">
    <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#modal-add-ulasan">
        <i class="fas fa-plus mr-2"></i>Add Inventaris
    </button>
...
<div id="modal-import" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('inventaris.import') }}" method="POST" enctype="multipart/form-data" class="modal-content">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title">Import Excel Inventaris</h5>
    ...
    <div id='modal-add-ulasan' class='modal fade' tabindex='-1'>
        <div class='modal-dialog modal-small'>
            <div class='modal-content'>
                <div class='modal-header'>
                    <h5 class='modal-title'>Add Inventaris</h5>
                    <button type='button' class='close' data-dismiss='modal'>&times;</button>
                </div>

                <div class='modal-body'>
                    <form action="inventaris" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                        @csrf        
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3"> Jenis_Barang <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" name="jenis_barang" class="form-control" value="" required placeholder="jenis barang">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <select class="form-control form-control-select2" name="asal_barang" data-fouc>  
                                    <option value="" disabled selected>Pilih Asal Barang</option>
                                    <option value="dibeli sendiri" >Dibeli Sendiri</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <select class="form-control form-control-select2" name="keadaan_barang" data-fouc>  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <select class="form-control form-control-select2" name="penghapusan_barang" data-fouc>  
    ...
    <div id='modal-resend-creds' class='modal fade' tabindex='-1'>
        <div class='modal-dialog modal-xs'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <h3 class="d-flex justify-content-center" style="margin: auto">Delete this Inventaris ?</h3>
                    <br>
                    <div class="text-right">
                        <form action="inventaris-delete" method="POST">
                            @csrf
