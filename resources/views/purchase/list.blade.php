    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('body').delegate('.btn-resend-creds', 'click', function(e){
                $ulasan_id = $(this).attr('ulasan_id')
                $('#modal-resend-creds #ulasan_id').val($ulasan_id);
        ...
        <div class='modal-dialog modal-xs'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    <br>
                    <div class="text-right">
                        <form action="ulasan-delete" method="POST">
                            @csrf

                            <input type="hidden" name="ulasan_id" id="ulasan_id">
